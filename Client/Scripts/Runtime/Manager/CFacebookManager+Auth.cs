...
#region 조건부 함수
	...
	private void OnLogin(ILoginResult a_oResult) {
		...
		CScheduleManager.Inst.AddCallback(KCDefine.B_KEY_FACEBOOK_M_LOGIN_CALLBACK, () => this.CallbackDict.ExGetVal(EFacebookCallback.LOGIN)?.Invoke(this, this.IsLogin));
	}
#endif // #if UNITY_IOS || UNITY_ANDROID
#endregion // 조건부 함수
}
