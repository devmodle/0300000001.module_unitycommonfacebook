...
#region 함수
	...
	public void Login(List<string> a_oPermissionList, System.Action<CFacebookManager, bool> a_oCallback, System.Action<CFacebookManager, bool> a_oChangeViewStateCallback = null) {
		...
		CFunc.Assert(a_oPermissionList.ExIsValid());
	...
	public void Logout(System.Action<CFacebookManager> a_oCallback) {
		...
		try {
			...
			CScheduleManager.Inst.AddCallback(KCDefine.B_KEY_FACEBOOK_M_LOGOUT_CALLBACK, () => CFunc.Invoke(ref a_oCallback, this));
		}
	}
#endregion // 함수
...
#region 조건부 함수
	...
	private void OnLogin(ILoginResult a_oResult) {
		...
		CScheduleManager.Inst.AddCallback(KCDefine.B_KEY_FACEBOOK_M_LOGIN_CALLBACK, () => this.CallbackDict.GetValueOrDefault(EFacebookCallback.LOGIN)?.Invoke(this, this.IsLogin));
	}
#endif // #if UNITY_IOS || UNITY_ANDROID
#endregion // 조건부 함수
}
